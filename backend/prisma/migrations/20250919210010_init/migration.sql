...
-- CreateIndex
CREATE UNIQUE INDEX "Post_authorId_retweetOfId_key" ON "public"."Post"("authorId", "retweetOfId");
...
-- AddForeignKey
ALTER TABLE "public"."Post" ADD CONSTRAINT "Post_retweetOfId_fkey" FOREIGN KEY ("retweetOfId") REFERENCES "public"."Post"("id") ON DELETE SET NULL ON UPDATE CASCADE;
